# Contributing to symphonyoss/click-to-call-integration
...
Commits and pull requests to FINOS repositories such as symphonyoss/click-to-call-integration will only be accepted from those contributors with an active, executed Individual Contributor License Agreement (ICLA) with FINOS OR who are covered under an existing and active Corporate Contribution License Agreement (CCLA) executed with FINOS. Commits from individuals not covered under an ICLA or CCLA will be flagged and blocked by the FINOS ["CLA Bot" tool](https://github.com/finos/cla-bot). Please note that some CCLAs require individuals/employees to be explicitly named on the CCLA.

As a result, PRs submitted to the symphonyoss/click-to-call-integration project cannot be accepted until you have a CLA in place with the Foundation.
